...
window.title("WaterMarkApplier")
window.resizable(False, False)


def select_file():
    """Handles the Open Button click event. Prompts the user to select a file and loads it into photo_label."""
...
OpacityWidget(window, on_opacity_change).grid(column=1, row=3)
